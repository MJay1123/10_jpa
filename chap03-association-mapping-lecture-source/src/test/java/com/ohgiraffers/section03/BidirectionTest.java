...
public class BidirectionTest {
    ...
    *  */
    ...
    public void 양방향_연관관계_매핑_조회_테스트(){
        ...
        /* 설명. 연관관계의 주인(자식 엔티티)은 한 번에 left join문으로 관계를 맺은 멘티티를 조회해 온다. */
        Menu foundMenu = entityManager.find(Menu.class, menuCode);
        System.out.println("foundMenu = " + foundMenu);
        System.out.println("10번 메뉴의 카테고리 : " + foundMenu.getCategory());

        /* 설명. 양방향은 부모에 해당하는 엔티티는 가짜 연관관계이고 필요 시 연관 관계 인티티를 조회하는 뭐리로 작성한다.
        ...
        *  */
        ...
        System.out.println("10번 카테고리의 메뉴들 : " + foundCategory.getMenuList());   // menu에 대한 select 방법
    }
}
