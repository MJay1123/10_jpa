    ...
    *  */
    ...
    public void 준영속성_detach_테스트(){
        ...
        *  */
        ...
        assertEquals(7000, entityManager.find(Menu.class, 12).getMenuPrice());
    }
...
//        entityManager.clear();      // 영속성 컨텍스트에 있는 모든 영속상태의 엔티티를 준영속 상태로 변경
    ...
    public void 병합_merge_수정_테스트(){
        ...
        System.out.println("첫번째 주소값 : " + menuToDetach.hashCode());
        System.out.println("두번째 주소값 : " + refoundMenu.hashCode());
