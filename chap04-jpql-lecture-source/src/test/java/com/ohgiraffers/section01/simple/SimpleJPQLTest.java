...
//        String jpql = "SELECT m.menuName FROM menu_section01 WHERE m.menuCode = 7";
...
//        for(Object object : resultColumns.get(0)){
//            System.out.println(object);
//        }
        Assertions.assertTrue(resultRow[0] instanceof String);
        Assertions.assertTrue(resultRow[1] instanceof String);
    }
